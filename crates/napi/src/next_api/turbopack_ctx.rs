    ...
    pub fn throw_turbopack_internal_error(
        ...
        async move {
            this.inner
                ...
                .call_async::<()>(Ok(TurbopackInternalErrorArgs {
                    message,
...
pub struct NapiNextTurbopackCallbacksJsObject {
    #[napi(ts_type = "(message: string, location: string | null) => never")]
...
pub struct NapiNextTurbopackCallbacks {
    ...
    // anyways).
    throw_turbopack_internal_error: ThreadsafeFunction<TurbopackInternalErrorArgs>,
}

/// Arguments for [`NapiNextTurbopackCallbacks::throw_turbopack_internal_error`].
pub struct TurbopackInternalErrorArgs {
    message: String,
        ...
        Ok(NapiNextTurbopackCallbacks {
            throw_turbopack_internal_error: obj
                ...
                .create_threadsafe_function(0, |ctx| {
                    let args: TurbopackInternalErrorArgs = ctx.value;
                    Ok(vec![Some(args.message), args.location])
                })?,
        })
    }
}
